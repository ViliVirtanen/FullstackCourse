...
describe('total likes', () => {
    ...
    test('when list has multiple blogs, equals the likes of that', () => {
      ...
      test('when list has only one blog with 0 likes, equals the likes of 0', () => {
        const result = listHelper.totalLikes(blogs.slice(4,5))
        expect(result).toBe(0)
      })

      test('when list has no blog, equals the likes of 0', () => {
  ...
  describe('most likes', () => {
    ...
    test('when list has multiple blogs, return the blog with highest likes', () => {
      ...
      test('when list has no blog, return obj with no values', () => {
